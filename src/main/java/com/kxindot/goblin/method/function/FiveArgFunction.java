 ...
 */
@FunctionalInterface
public interface FiveArgFunction<T, P1, P2, P3, P4, P5, R> extends Serializable {
    
    R apply(T t, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5);
    
    default <V> FiveArgFunction<T, P1, P2, P3, P4, P5, V> andThen(Function<? super R, ? extends V> after) {
        Objects.requireNotNull(after);
        return (T t, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5) -> after.apply(apply(t, p1, p2, p3, p4, p5));
    }
}