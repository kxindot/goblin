 ...
 */
@FunctionalInterface
public interface FiveArgConsumer<T, P1, P2, P3, P4, P5> extends Serializable {

	void accept(T t, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5);

    default FiveArgConsumer<T, P1, P2, P3, P4, P5> andThen(FiveArgConsumer<? super T, ? super P1, ? super P2, ? super P3, ? super P4, ? super P5> after) {
        Objects.requireNotNull(after);
        return (l, r1, r2, r3, r4, r5) -> {
            accept(l, r1, r2, r3, r4, r5);
            after.accept(l, r1, r2, r3, r4, r5);
        };
    }
}
